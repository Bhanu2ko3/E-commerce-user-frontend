  ...
  <div className="bg-gray-50 p-10">
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-xl">
      ...
      <div className="mb-10 p-6 bg-gray-100 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-primary mb-4 text-center">Objectives</h2>
        <p className="text-lg text-gray-700">
      ...
      <div className="p-6 bg-gray-100 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-primary mb-4 text-center">Values</h2>
        <p className="text-lg text-gray-700">
